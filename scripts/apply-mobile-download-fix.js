...
// Fixed pattern: adds mobile detection and ?download=true param
...
filesToPatch.forEach(filePath => {
  ...
  try {
    ...
    if (content.includes(originalDownloadAtt) && !content.includes(fixedDownloadAtt)) {
    ...
    if (content.includes(originalDownloadObject) && !content.includes(fixedDownloadObject)) {
